 ...
 * @brief Messages from the device to the cloud are sent by filling in the relevant information of the ALIYUN platform
 * @n If the Message is sent successfully, you can see "Message is sent." in the serial port, and you can see the
 * @n Message you sent on the ALIYUN platform
 ...
 */
char *pubTopic = (char *)"your_pubTopic"; //******post
...
void loop() {
  ...
  myBC20.publish(pubTopic, (char *)"hello");
