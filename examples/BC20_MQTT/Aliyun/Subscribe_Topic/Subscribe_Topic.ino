 ...
 *@brief You can subscribe to the ALIYUN topic by filling in the information about the ALIYUN platform
 *@n By using the ALIYUN platform to publish messages, you can see the corresponding topic messages
 ...
 */
char *ProductKey = (char *)"your_ProductKey";
char *ClientId = (char *)"your_ClientId"; /*Custom id*/
char *DeviceName = (char *)"your_DeviceName";
char *DeviceSecret = (char *)"your_DeviceSecret";

/*
 *Configure the domain name and port number
 */
char *ALIYUN_SERVER = (char *)".iot-as-mqtt.cn-shanghai.aliyuncs.com";
char *PORT = (char *)"1883";

/*
 *Product identifier that needs to be operated
 */
char *Identifier = (char *)"your_Identifier";

/*
 *TOPIC that need to be subscribed
 */
char *subTopic = (char *)"your_subTopic"; //****set
...
void setup() {
  ...
  while (myBC20.configKeepalive((char*)"300") == 0);
