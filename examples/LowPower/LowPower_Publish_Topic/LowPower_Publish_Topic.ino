 ...
 *@brief This demo adds low-power content to the regular IOTdemo, where you can see the NB module being awakened
 *@n in a loop on the serial monitor and then upload the message to the cloud
...
char *Iot_id = (char *)"your_Iot_id";
char *Client_ID = (char *)"your_Client_ID";
char *Iot_pwd = (char *)"your_Iot_pwd";

/*Configure the domain name and port number*/
char *EasyIot_SERVER = (char *)"182.254.130.180";
char *PORT = (char *)"1883";

/*Set the Topic you need to publish to*/
char *pubTopic = (char *)"your_pubTopic";
